...
/**
 * Contient les methodes qui modelise le calcul scientifique pour trouver la metrique de similarite entre 2 chaine
 * d'ARN.
 * Les 3 methodes sont les 3 parties pour calculer la metrique et doivent absolument toutes 3 etre utiliser.
 ...
 *
 * Prend en parametre 2 chaine d"ARN unique ou identique ainsi que la distance maximum entre 2 acides amine
 ...
 * @param distance la distance maximum a laquelle 2 acides amine se trouvent lorsque l'on compare deux ARN.
 * @return resultat la mesure de la deviation entre 2 chaine d'ARN.
*/
    public static double calculDeviation ( ArrayList <acideAmines> chaine1, ArrayList <acideAmines> chaine2,
                                             double distance ) {
     ...
     * @return resultat la mesure de la deviation entre 2 chaine d'ARN.
     */
    public static double calculDeviationPonderee ( ArrayList <acideAmines> chaine1, ArrayList <acideAmines> chaine2,
                                                     double distance ) {
        double resultat;
